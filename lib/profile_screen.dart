...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  int get languagesUsed => TranslationHistory.sessions
      .map((s) => '${s['from']}_${s['to']}')
      .toSet()
      .length;
          ...
          child: Column(children: [
            ...
            Padding(
              ...
              child: Container(
                ...
                child: Row(
                    ...
                    children: [
                      _stat(totalTranslations.toString(), 'Total',
                          Icons.translate_rounded),
                      _vDivider(),
                      _stat(todaySessions.toString(), 'Today',
                          Icons.today_rounded),
                      _vDivider(),
                      _stat(languagesUsed.toString(), 'Languages',
                        ...
                        child: Column(
                            ...
                            children: [
                              ...
                              const Text('Synced with Settings',
                                  style: TextStyle(
                                      color: Color(0xFF10A37F), fontSize: 10)),
                            ])),
                    Container(
                      padding: const EdgeInsets.symmetric(
            ...
            Padding(
              ...
              child: Container(
                ...
                child: Column(children: [
                  _option(Icons.notifications_rounded, 'Notifications',
                      'Manage alerts',
                          () => _showComingSoon('Notifications')),
                  _hDivider(),
                  _option(Icons.privacy_tip_rounded, 'Privacy Policy',
                      'How we use your data',
                          () => _showComingSoon('Privacy Policy')),
                  _hDivider(),
                  _option(Icons.help_rounded, 'Help & Support',
                      'Get assistance',
                          () => _showComingSoon('Help & Support')),
                  _hDivider(),
                  _option(Icons.info_rounded, 'About TranslateAR',
                      'Version 1.0.0', () {
                        showAboutDialog(
                          context: context,
      ...
      Column(children: [
        Text(value,
            style: const TextStyle(
                ...
                fontWeight: FontWeight.w700)),
        const SizedBox(height: 2),
        Text(label, style: TextStyle(color: _t.txMut, fontSize: 12)),
      ]);

  Widget _vDivider() =>
      Container(width: 1, height: 34, color: _t.divider);
      ...
      child: Padding(
        ...
        child: Row(children: [
          Container(
              ...
              child: Icon(icon,
                  color: const Color(0xFF10A37F), size: 17)),
          const SizedBox(width: 14),
          Expanded(
              child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    ...
                    Text(subtitle,
                        style:
                        TextStyle(color: _t.txMut, fontSize: 11)),
                  ])),
          Icon(Icons.chevron_right_rounded,
              color: _t.txDead, size: 18),
        ]),
      ),
    );
  }
